...
console.log(age)
// A:console.log(givenName + " "+ 'is'+ (today-born) + " "+ "years old")
console.log(givenName + " " + "is" + " "+ (today-born) + " "+ "years old")
...
// A:
var yourName = "Emma";
var instructorName = "Lexi" + ", and there's also some dude who hangs with us named " + "Doug";
...
let myNumber = 11;
let myString = "r";
let myBoolean = (null || undefined) || NaN;
let name = undefined;

let providedName = name ? name : "No name provided";

console.log(name ? "Name is " + name : "No name :(" );
